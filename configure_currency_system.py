        ...
        for market in markets:
            ...
            if data_points:
                ...
                try:
                    ...
                    estimated_people_per_market = 1000  # Fallback
...
def generate_marketcap_analysis():
    ...
    try:
        ...
        if len(markets) >= 2:
            ...
            print(
                f"Mercado com maior valor: {markets[market_values.index(max_market)].name}"
            )
            print(
                f"Mercado com menor valor: {markets[market_values.index(min_market)].name}"
            )
